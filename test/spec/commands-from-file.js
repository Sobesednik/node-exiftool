...
const libTestSuite = {
    ...
    //         })
    // },
            // return Promise.resolve('/var/folders/s0/zp77ycl55kl4hy39s889z3xc0000gn/T/node-exiftool_test_25917.data')
    Exiftool: {
        context,
        ...
        'should read metadata': (ctx) => {
            ...
            return ctx.createDataFile(null, 'data')
                ...
                .then(() => {
                    ...
                    const closePromise = new Promise(resolve => ctx.ep._process.on('close', () => {
                        console.log('process closed')
                        resolve()
                    }))

                    // return ctx.writeToDataFile('-stay_open\nfalse\n')
                        // .then(() => {
                    return closePromise
                        // })
                })
